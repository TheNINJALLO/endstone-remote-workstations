...
py::dict command_state(endstone::Player& player,int x,int y,int z,uint64_t generation=0) {
...
py::dict command_entity_state(endstone::Player& player,endstone::Actor& source,uint64_t generation=0) {
