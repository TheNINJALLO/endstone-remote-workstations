...
py::dict structure_state(endstone::Player& player,int x,int y,int z,uint64_t generation=0) {
    ...
    py::dict result; result["active"]=active; result["can_interact"]=command_authorized(bound);
