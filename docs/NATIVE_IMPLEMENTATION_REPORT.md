...
The native source checkpoint is `ca3025524ff754f87a66df4dec4756c964855d82` on
...
ABI facts. It now also admits six original workstations: anvil, smithing,
stonecutter, grindstone, loom and cartography. The exact current build completed
...
survived disconnect/reconnect in this build. An unfinished stonecutter input also
...
- Linux ASan/UBSan at `ca30255`: its CI job passed **13/13 tests** and 100,000 libFuzzer inputs each for NBT,
...
[`checkpoint-ca30255.json`](../research/native-evidence/checkpoint-ca30255.json).
Older checkpoints keep their original source and artifact identities.

At `ca30255`, [native CI run 34305440978](https://github.com/TheNINJALLO/endstone-remote-workstations/actions/runs/34305440978)
...
refuses the incomplete catalog. [Legacy regression run 34305440996](https://github.com/TheNINJALLO/endstone-remote-workstations/actions/runs/34305440996)
...
|---|---|---|
| Linux x64 | `dist/linux-x64-dev/plugins/endstone_onistone_vcf.so` | `ccc60ce2cf6e837e2ab550fa70bc646a18cc7d23dff4da8a3b9091d53c9b8963` |
...
orchestration behind an opt-in flag. Six Linux workstations and four shared
