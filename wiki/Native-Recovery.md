...
[The compact evidence record](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/v0.5.0-native.1/research/native-linux-inventory-writer-sdk15.json)
contains the item and journal digests.

![The transferred filled bundle retains its complete native digest](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/v0.5.0-native.1/docs/images/native-inventory-writes/filled-bundle-after-transfer.png)

![Original slots restored after vanilla extraction of all six stones](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/v0.5.0-native.1/docs/images/native-inventory-writes/restored-inventory.png)
...
[six-boundary BDS crash tests](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/v0.5.0-native.1/docs/NATIVE_INVENTORY_CRASH_TESTS.md) passed crash
