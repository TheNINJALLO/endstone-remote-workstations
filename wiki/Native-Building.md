...
see [the SDK setup](https://github.com/TheNINJALLO/endstone-remote-workstations/wiki/Native-SDK#use-the-installed-cmake-package). CTest verifies
...
[Windows Docker setup](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/v0.5.0-native.1/docs/WINDOWS_DOCKER_SETUP.md) and
[Linux runtime evidence](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/v0.5.0-native.1/docs/NATIVE_LINUX_RUNTIME.md). This does not certify an
