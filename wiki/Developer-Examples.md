...
[Home](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/README.md) · [API reference](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/docs/DEVELOPER_API.md) · [Runnable demo](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/examples/dependency_plugin/README.md)
...
![Native anvil](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/main/docs/assets/anvil.png)
...
![Actual Ender Chest](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/main/docs/assets/ender-chest.png)
...
![Protected inventory menu](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/main/docs/assets/custom-menu.png)
...
menu before invoking that callback. The [complete demo source](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/examples/dependency_plugin/src/endstone_rw_ui_example/__init__.py)
...
Use [the catalog](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/docs/CAPABILITIES.md) for chest, hopper, brewing, beacon, crafter
...
another world are not valid source configuration. See [entity contracts](https://github.com/TheNINJALLO/endstone-remote-workstations/blob/main/docs/LINKED_ENTITIES.md).
...
limitations in [support](https://github.com/TheNINJALLO/endstone-remote-workstations/wiki/Compatibility-and-Limits) before enabling them.
...
![Element Constructor](https://raw.githubusercontent.com/TheNINJALLO/endstone-remote-workstations/main/docs/assets/chemistry.png)
