...
extern "C" const void* request_manager(const Player* p){return p->item_stack_net_manager_.get();}
extern "C" size_t pending_requests(const std::deque<void*>* p){return p->size();}
extern "C" size_t request_queue_size(){return sizeof(std::deque<void*>);}
