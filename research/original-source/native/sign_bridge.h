...
py::dict sign_state(endstone::Player& player,int x,int y,int z,uint64_t generation=0) {
...
py::dict jigsaw_state(endstone::Player& player,int x,int y,int z,uint64_t generation=0) {
