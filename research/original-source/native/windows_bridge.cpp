...
PYBIND11_MODULE(_rw_native,module) {
    ...
    module.def("held_watch",&held_watch);
    module.def("held_epoch",&held_epoch);
    module.def("held_release",&held_release);
    module.def("held_pack",&held_pack);
    module.def("held_unpack",&held_unpack);
    module.def("held_clone",&held_clone,py::arg("item"),py::arg("amount")=-1);
    module.def("held_apply",&held_apply);
    module.def("held_health",&held_health);
